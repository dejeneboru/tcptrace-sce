...
struct module {
    ...
    /* If you want to attach a module-specific structure to this */
...
#ifdef LOAD_MODULE_IP
    {TRUE,		         /* make FALSE if you don't want to call it at all */
     "ip",			/* name of the module */
     "IP analysis package",	/* description of the module */
     ip_mod_init,		/* routine to call to init the module */
     ip_mod_tcp_read,			/* routine to pass each TCP segment */
     ip_mod_done,		/* routine to call at program end */
     ip_mod_usage,		/* routine to call to print module usage */
     NULL,			/* routine to call on each new file */
     NULL,			/* routine to call on each new connection */
     ip_mod_udp_read,			/* routine to pass each UDP segment */
     NULL,			/* routine to call on each new UDP conn */
     ip_mod_pkt_read,	/* routine to pass each non-tcp and non-udp 
				    packets*/
     NULL},			/* routine to remove TCP connections */
#endif /* LOAD_MODULE_IP */

#ifdef LOAD_MODULE_SCTP
    {TRUE,		         /* make FALSE if you don't want to call it at all */
     "sctp",			/* name of the module */
     "SCTP analysis package",	/* description of the module */
     sctp_mod_init,		/* routine to call to init the module */
     NULL,			/* routine to pass each TCP segment */
     sctp_mod_done,		/* routine to call at program end */
     sctp_mod_usage,		/* routine to call to print module usage */
     NULL,			/* routine to call on each new file */
     NULL,			/* routine to call on each new connection */
     NULL,			/* routine to pass each UDP segment */
     NULL,			/* routine to call on each new UDP conn */
     sctp_mod_nontcpudp_read,	/* routine to pass each non-tcp and non-udp 
				    packets*/
     NULL},			/* routine to remove TCP connections */
...
#ifdef LOAD_MODULE_STRACE
    {TRUE,			/* make FALSE if you don't want to call it at all */
     "strace",			/* name of the module */
     "strace analysis package",	/* description of the module */
     strace_mod_init,		/* routine to call to init the module */
     NULL,			/* routine to pass each TCP segment */
     strace_mod_done,		/* routine to call at program end */
     strace_mod_usage,		/* routine to call to print module usage */
     NULL,			/* routine to call on each new file */
     NULL,			/* routine to call on each new connection */
     NULL,			/* routine to pass each UDP segment */
     NULL,			/* routine to call on each new UDP conn */
     NULL,			/* routine to pass each non-tcp and non-udp 
				    packets*/
     NULL},			/* routine to remove TCP connections */
