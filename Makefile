...
DEFINES += -DLOAD_MODULE_SCTP

DEFINES += -DLOAD_MODULE_STRACE
PCAP_LDLIBS += -lpcre

DEFINES += -DLOAD_MODULE_IP
...
MODULES=mod_http.c mod_traffic.c mod_rttgraph.c mod_tcplib.c mod_collie.c \
	mod_slice.c mod_realtime.c mod_inbounds.c mod_sctp.c mod_strace.c \
	mod_ip.c
